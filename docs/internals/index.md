...
For contributors and the deeply curious. These are the **source-of-truth**
design documents — every architectural choice is captured here.

- [Architecture](../ARCHITECTURE.md) — the full system design
- [Decisions (ADRs)](../DECISIONS.md) — 39+ locked decisions Q1–Qn with rationale
- [Roadmap](../ROADMAP.md) — milestone plan + what's deferred
